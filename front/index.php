...
<!--<![endif]-->
	<head>
		...
		<title>sisbolão - Gerenciador de apostas</title>
	...
	<body>
		...
		<div class="page-wrap">
				...
				<div class="top-header__container container px-md-2 py-2 rounded">
					<div class="row m-0">
						<nav class="navbar col-12 col-md-4 text-center text-md-left">
							<a class="navbar-brand mx-auto ml-md-0 mr-md-3" href="#">
						...
						<nav class="navbar navbar-expand-md col-md-8 navbar-light d-none d-md-flex">
							<div class="collapse navbar-collapse">
								<ul class="navbar-nav mr-auto">
									...
									<li class="nav-item px-md-2 d-none">
										<a role="button" href="#!" class="btn btn-md btn-pal-2 text-white">Cadastre-se</a>
									</li>
									<li class="nav-item px-md-2">
									<a role="button" href="#!" class="btn btn-md btn-pal-1 text-white">Fazer Login</a>
									</li>
								</ul>
							</div>
						</nav>
			...
			<section id="hero" class="py-5">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-6 align-self-md-center text-center text-md-left">
							<div class="h1 text-white text-uppercase font-weight-extra-bold">Lorem ipsum dolor</div>
							<div class="h3 text-white font-weight-normal">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat</div>
						</div>
						<div class="col-12 col-md-6 col-lg-5 offset-lg-1">			
							<div class="p-5 bg-white rounded box-shadow-spread-white--2 mt-5 mt-md-0">
								<form>
									<div class="row">
										<div class="col-12">
										...
										<div class="col-12">
											<button type="submit" class="btn btn-lg btn-pal-2 text-uppercase small py-4 px-5 w-100">Cadastrar</button>
										</div>
									</div><!-- /.row !-->
								</form>
							</div>
