...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>sisbolão - Meus Bolões - Painel de Controle</title>
						...
						<div class="container">
							<div class="row">
								<ol class="breadcrumb bg-transparent m-0 small">
									...
									<li class="breadcrumb-item active" aria-current="page">Meus Bolões</li>
								</ol>
							</div><!-- /.row !-->
						</div><!-- /.container !-->
					</nav><!-- /breadcrumb !-->
								...
								<div class="card-header bg-white">
									<div class="row">
										<div class="col-6 pt-2">
											<h5 class="text-muted font-weight-light">Meus Bolões</h5>
										</div>
									</div>
								</div><!-- /.card-header !-->
								<div class="card-body">
									<div class="table-responsive-sm">
										<table class="table table-hover small">
											...
											<tbody>
												<tr>
													...
													<td>
                                                        <a href="#!" class="btn btn-sm btn-pal-1">
															<small>Cadastrar Resultados</small>
														</a>
                                                ...
                                                <tr>
													<td>
														<i class="fas fa-lock text-black-50" title="Público - Aberto à todos"></i>
													</td>
