...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>sisbolão - Cadastrar Campeonato - Painel de Controle</title>
                                ...
                                <div class="card-header bg-white">
                                    <div class="row">
                                        <div class="col-6 pt-2">
                                            <h5 class="text-muted font-weight-light">Cadastrar Campeonato</h5>
                                        </div>
                                    </div>
                                </div><!-- /.card-header !-->
                                <div class="card-body">
						...
						<div class="col-12">
							<div class="card border-0 rounded p-3 blur-shadow mr-0">
								<div class="card-header bg-white">
									<div class="row">
										<div class="col-6 pt-2">
											<h5 class="text-muted font-weight-light">Campeonatos Cadastrados</h5>
										</div>
									</div>
								</div><!-- /.card-header !-->
								<div class="card-body">
