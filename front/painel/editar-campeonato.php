...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>sisbolão - Editar Campeonato - Painel de Controle</title>
                                ...
                                <div class="card-header bg-white">
                                    <div class="row">
                                        <div class="col-6 pt-2">
                                            <h5 class="text-muted font-weight-light">Editar Campeonato</h5>
                                        </div>
                                    </div>
                                </div><!-- /.card-header !-->
                                <div class="card-body">
                                        ...
                                        <div class="row justify-content-center justify-content-md-start">
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="name" id="name" class="form-control form-control-lg" value="Campeonato Brasileiro - Série A">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
