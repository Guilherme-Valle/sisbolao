...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>sisbolão - Editar Conta - Painel de Controle</title>
								...
								<div class="card-header bg-white">
									<div class="row">
										<div class="col-6 pt-2">
											<h5 class="text-muted font-weight-light">Alterar e-mail</h5>
										</div>
									</div>
								</div><!-- /.card-header !-->
								<div class="card-body">
                                        ...
                                        <div class="row justify-content-center justify-content-md-start">
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label for="email" class="text-secondary">E-mail atual</label>
                                                    <input type="email" id="email" class="form-control form-control-lg" disabled value="lucasljsb@gmail.com">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label for="newemail" class="text-secondary">Novo e-mail</label>
                                                    <input type="email" id="newemail" class="form-control form-control-lg">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <button type="submit" class="btn btn-lg btn-pal-1 text-uppercase small py-4 px-4">Confirmar alteração</button>
                                            </div>
                                        </div><!-- /.row !-->
                                    </form>
								</div><!-- /.card-body !-->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card border-0 rounded p-3 blur-shadow mr-0">
								<div class="card-header bg-white">
									<div class="row">
										<div class="col-6 pt-2">
											<h5 class="text-muted font-weight-light">Alterar senha</h5>
										</div>
									</div>
								</div><!-- /.card-header !-->
								<div class="card-body">
                                    <form>
                                        <div class="row justify-content-center justify-content-md-start">
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label for="password" class="text-secondary">Nova senha</label>
                                                    <input type="password" id="password" class="form-control form-control-lg">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label for="newpassword" class="text-secondary">Repita a senha</label>
                                                    <input type="password" id="newpassword" class="form-control form-control-lg">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <button type="submit" class="btn btn-lg btn-pal-2 text-uppercase small py-4 px-4">Confirmar alteração</button>
                                            </div>
                                        </div><!-- /.row !-->
                                    </form>
								</div><!-- /.card-body !-->
